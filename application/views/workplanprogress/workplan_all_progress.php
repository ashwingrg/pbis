							...
							<div class="col-lg-12" style="margin:0px; padding:0px;">
			                    <div class="panel panel-default">
			                        <div class="panel-heading">
			                            All workplan detail availabel in database
			                        </div>
			                        <!--panel-heading ends-->
			                                    	...
			                                    	if($divname=="Administration"){
			                                    		...
			                                    		<tr class="odd">
				                                            ...
				                                            <td class="center" style="margin:0px; padding:5px 0px 0px 7px;">
				                                            	...
				                                            	<button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo site_url('home/viewwpd/').'/'.$adwpd->wpd_id; ?>';">View</button>
				                                            	<?php if($adwpd->remarks=="approved" && $adwpd->division_name=="Administration"){ ?>
				                                            	<button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo site_url('home/workplandetail/progress');  ?>';">Enter Progress</button>
				                                            	<?php } ?>
				                                            </td>
			                                        	</tr>
			                                    	...
			                                    	elseif($divname=="exco"){
														...
														<tr class="odd">
				                                            ...
				                                            <td class="center" style="margin:0px; padding:5px 0px 0px 7px;">
				                                            	...
				                                            	<button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo site_url('home/viewwpd/').'/'.$awpd->wpd_id; ?>';">View</button>
				                                            	<?php if($awpd->remarks=="approved" && $d->user_fullname==$awpd->division_chief && $awpd->progress_for==""){ ?>
				                                            	<button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo site_url('home/workplanprogress').'/'.$awpd->wpd_id;  ?>';">Enter Progress</button>
				                                       			<?php } ?>     	
				                                            </td>
			                                        	</tr>
