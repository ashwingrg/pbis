								    ...
								    <div class="tab-content" style="padding-top:1.5em;">
								    	<div class="tab-pane active" id="newworkpan">
								    		...
								    		<form action="" method="post" class="form-horizontal " style="margin-top:-1em;">
								    			...
								    			<table class="table table-responsive table-bordered">
												    ...
												    <tbody>
												        ...
												        <tr>
												            ...
												            <td>
												            	<small>Measurement:</small>&nbsp;<strong><?php echo $allwpdact->measurement; ?></strong>
												            </td>
												            <td>
												            	<small>Score:</small>&nbsp;<strong><?php echo $allwpdact->score; ?></strong>
												            </td>
												            <td>
												            	<small>Progress:</small>&nbsp;<strong><?php echo $allwpdact->progress; ?></strong>
												            </td>
									    		...
									    		<p>
									    			<button type="button" class="btn btn-primary" style="margin-left:1em; border-radius:0px;" onclick="window.location.href='<?php echo site_url('home/workplanprogress'); ?>';"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;&nbsp;Go Back</button>
									    			<?php 
									    				if($divname=="Administration"){
									    			?>
													<button type="button" class="btn btn-primary" style="margin-left:1em; border-radius:0px;" onclick="window.location.href='<?php echo site_url('home/progresstoexco').'/'.$wpd->wpd_id; ?>'" ><span class="glyphicon glyphicon-arrow-up"></span>&nbsp;&nbsp;Send to ExCo</button>
													<?php } ?>
													<?php 
														if($divname=="ExCo" && $wpd->exco_approve==""){
													?>
														<button type="button" class="btn btn-primary" style="margin-left:1em; border-radius:0px;" onclick="window.location.href='<?php echo site_url('home/wppapproved').'/'.$wpd->wpd_id; ?>'" ><span class="glyphicon glyphicon-arrow-up"></span>&nbsp;&nbsp;Approve</button>
														<button type="button" class="btn btn-primary" style="margin-left:1em; border-radius:0px;" onclick="window.location.href='<?php echo site_url('home/wppdisapproved').'/'.$wpd->wpd_id; ?>'" ><span class="glyphicon glyphicon-arrow-up"></span>&nbsp;&nbsp;Disapprove</button>	
													<?php
														}
													?>
									    		</p>
