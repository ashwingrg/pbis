<?php 
	...
	$userdiv = $userdata->division_name;
?>
					...
					<div class="col-lg-12" style="margin:0px; padding:0px;">
						...
						<div class="row">
							<div class="col-lg-7 col-md-5 col-sm-5 col-xs-12" style="margin:0px; padding:0px;">
								<h1 style="margin:2px 0px 11px 0px; font-weight:bold;">ExCo Members</h1>
							</div>
							...
							<div class="col-lg-12" style="margin:0px; padding:0px;">
			                    <div class="panel panel-default">
			                        <div class="panel-heading">
			                            ExCo Members availabel in database
			                        </div>
			                        <!--panel-heading ends-->
			                        <div class="panel-body">
			                            ...
			                            <div class="table-responsive">
			                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
			                                    ...
			                                    <?php 
			                                    	$sn = 0;
			                                    	foreach($exco as $excodet): 
			                                    		$sn = $sn+1;
			                                    ?>	
			                                        <tr class="odd">
			                                        	<td style="text-align:center;"><?php echo $sn; ?></td>
			                                            <td><?php echo $excodet->user_fullname; ?></td>
			                                            <td><?php echo $excodet->user_email; ?></td>
			                                            <td><?php echo $excodet->user_username ?></td>
			                                            <td class="center"><?php echo $excodet->division_name; ?></td>
			                                            <td><?php echo $excodet->user_type ?></td>
			                                            <?php if($userdiv == "Administration"){ ?>
			                                            <td class="center" style="margin:0px; padding:5px 0px 0px 7px;">
			                                            
			                                            	<button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo site_url('home/exco/update').'/'.$excodet->user_id; ?>';">Edit</button>
			                                            	<button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo site_url('home/exco/delete').'/'.$excodet->user_id; ?>';">Delete</button>
